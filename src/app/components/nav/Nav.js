      ...
      <NavWrap>
        <HideOnScroll {...props}>
          ...
          >
                    ...
                    >
                      <Link href="/technology">
                        <MenuItem onClick={handleClose2}>
                          Enclosure Technology (AHS)
                        </MenuItem>
                      </Link>
                      <Link href="/technology#sec2">
                        <MenuItem onClick={handleClose2}>
                          Robot technology (ARS)
                        </MenuItem>
                      </Link>
                      <Link href="/technology#sec3">
                        <MenuItem onClick={handleClose2}>
                          Light Source Technology (ASS)
                        </MenuItem>
                      </Link>
                      <Link href="/clibo">
                        <MenuItem onClick={handleClose2}>CLIBO</MenuItem>
                      </Link>
                    </StyledMenu>
                  </li>
                  <li>
                    ...
                    >
                      <Link href="/news">
                        <MenuItem onClick={handleClose3}>News & data</MenuItem>
                      </Link>
                    </StyledMenu>
                  </li>
                </ul>
            ...
            {page == 'tech' ? (
              <TechSubNav
                text1={'Enclosure Technology (AHS)'}
                text2={'Robot technology (ARS)'}
                text3={'Light Source Technology (ASS)'}
              />
            ) : (
              <></>
            )}
            {page == 'clibo' ? (
              <TechSubNav
                text1={'CLIBO Configuration'}
                text2={"CLIBO's Clean Function"}
                text3={'CLIBO Applied Technologies'}
              />
            ) : (
              <></>
            )}
