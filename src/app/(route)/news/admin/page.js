            ...
            <TabBoxWrap sx={{ width: '100%' }}>
              ...
              <StyledCustomTabPanel value={value} index={0}>
                <NewsBox
                  ...
                  title={'Innovation in Clean Services'}
                ...
                <BasicModal
                  ...
                  text={'Innovation in Clean Services'}
                  img={'/img/news/news1.png'}
                />

                <NewsBox
                  img={'/img/news/news2.png'}
                  title={'Participation in RoboWorld 2024'}
                ...
                <BasicModal
                  ...
                  text={'Participation in RoboWorld 2024'}
                  img={'/img/news/news2.png'}
                />

                <NewsBox
                  img={'/img/news/news3.png'}
                  title={'Selected by Korea Hydro & Nuclear Power (KHNP)'}
                ...
                <BasicModal
                  ...
                  text={'Selected by Korea Hydro & Nuclear Power (KHNP)'}
                  img={'/img/news/news3.png'}
                />

                <NewsBox
                  img={'/img/news/news4.png'}
                  title={'Excellence Award at the Startup Competition'}
                ...
                <BasicModal
                  ...
                  text={'Excellence Award at the Startup Competition'}
                  img={'/img/news/news4.png'}
                />
                ...
                <NewsBox
                  ...
                  title={
                    'Minister of Small and Medium Enterprises and Startups Award'
                  }
                ...
                <NewsBox
                  ...
                  title={'Participation in CES 2024'}
                ...
                <BasicModal
                  ...
                  text={'Participation in CES 2024'}
                  img={'/img/news/news6.png'}
                />
              ...
              <StyledCustomTabPanel value={value} index={1}>
                ...
                <BasicModal
                  ...
                  text={'2024 CLIBO Catalog'}
                  img={'/img/news/document1.png'}
                />

                <NewsBox
                  img={'/img/news/document2.png'}
                  title={'2022 AVS Catalog'}
                ...
                <BasicModal
                  ...
                  text={'2022 AVS Catalog'}
                  img={'/img/news/document2.png'}
                />

                <NewsBox
                  img={'/img/news/document3.png'}
                  title={'2021 AVS Catalog'}
