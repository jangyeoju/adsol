        ...
        <TechnologyWrap>
          <SubBannerWrap>
            <SubBanner title={'Technology'}>
              <p>
                Advance Solutions is a ROBOT solution company
                <br /> that makes realizable changes now with a different
                perspective.
              </p>
            </SubBanner>
          </SubBannerWrap>
          <ContainerWrap>
            <ul className="technology-info-box">
              <li>
                ...
                <p>
                  It has core manufacturing technology of robots, the
                  crystallization of convergence technology, to develop and
                  produce convenient and fast price competitive robots
                  regardless of the type of robot.
                </p>
              </li>
              <li>
                <h5>02</h5>
                ...
                <p>
                  Based on our in-house capabilities, we develop new items and
                  adopt a strategy of internalizing key components. By choosing
                  domestic processing and manufacturing, we reduce costs and
                  drive improvements, delivering innovative and unique robots
                  exclusively from Advance Solution.
                </p>
              </li>
              <li>
                <h5>03</h5>
                ...
                <p>
                  All technologies, including H/W, S/W, and AI, can be developed
                  on their own and mass-produced separately as robots with
                  functions and designs suitable for the needs of robot
                  development. (Customized design, customization for each part,
                  mass production of enclosures based on AHS)
                </p>
              </li>
            </ul>
            <ModuleWrap>
              <ContainerWrap>
                <div className="left-box">
                  <div>
                    ...
                    <p>
                      Advance Solutions is a ROBOT solution company that makes
                      realizable changes now with a different perspective.
                    </p>
                  </div>
            ...
            <ContainerWrap>
              <ul className="technology-title">
                <li>
                  ...
                  <h2>
                    ...
                    <strong className="montserrat"> AHS</strong>
                  </h2>
                  <img src="/img/technology/Arrow.svg" />
                </li>
                <li>
                  <p>
                    By using standardized components and a one-touch assembly
                    method without molds, production costs are reduced, and
                    manufacturing lead times are shortened. The modular
                    structure enables compatibility with various devices and
                    customization based on customer requests. By applying design
                    elements, we were recognized as a K-Design Award Winner.
                  </p>
                </li>
              </ul>
              <div className="ahs-box-wrap">
                <div className="ahs1 ahs-box">
                  ...
                  <p>
                    Compatible with various devices through a modular structure.{' '}
                  </p>
                </div>
                <div className="ahs-box-wrap2">
                  <div className="ahs2 ahs-box">
                    ...
                    <p>
                      Improves production efficiency with
                      <br /> one-touch assembly technology.
                    </p>
                  </div>
                  <div className="ahs3 ahs-box">
                    <h3>Standardized Components</h3>
                    <p>
                      Enables diverse product lineups
                      <br /> using standardized components.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="cost-wrap">
              <ContainerWrap>
                ...
                <p className="sub-title-detail">
                  Reduces production costs and minimum order quantities while
              ...
              <ContainerWrap>
                <ul className="technology-title">
                  <li>
                    ...
                    <h2>
                      Robot Technology
                      <strong className="montserrat"> ARS</strong>
                    </h2>
                    <img src="/img/technology/Arrow2.svg" />
                  </li>
                  <li>
                    <p>
                      Technology for contamination-oriented driving management
                      that preemptively cleans contaminated areas. Automated
                      station technology that replaces filters and batteries
              ...
              <ContainerWrap>
                ...
                <ul className="ars-box-wrap">
                  <li>
                    ...
                    <p>
                      Prioritizes cleaning highly contaminated areas efficiently
                  ...
                  <li>
                    ...
                    <p>
                      Robot driving tests
                      <br /> (space recognition rate, driving occupancy rate,
                ...
                <div className="ars-img-box p-wrap">
                  <div className="ars-text">
                    ...
                    <h1>
                      ...
                      <br /> battery replacement station.
                    </h1>
                  </div>
              ...
              <ContainerWrap>
                <div className="ars-img-box p-wrap">
                  <div className="ars-text">
                    ...
                    <h1>Alignment technology using a guide.</h1>
                  </div>
                  <div className="ars-img">
                ...
                <ContainerWrap>
                  <div className="ars-img-box">
                    ...
                    <div className="ars-text">
                      ...
                      <h1>Filter automatic replacement technology</h1>
                    </div>
                  </div>
                </ContainerWrap>
              </div>
          ...
          <TechnologySection3 id="sec3">
            <ContainerWrap>
              <ul className="technology-title">
                <li>
                  ...
                  <h2>
                    ...
                    <strong className="montserrat"> ASS</strong>
                  </h2>
                  <img src="/img/technology/Arrow.svg" />
                </li>
                <li>
                  <p>
                    Sterilization light source with a special far-ultraviolet
                    wavelength that is harmless to humans. Retractable
                    (open/close) ultraviolet light source ensures safety.
                  </p>
                </li>
              </ul>
              <div className="a-link-list">
                <div className="a-link">
                  <Link href="#tech1">
                    Light Source Storage (Retractable) Technology
                  </Link>
                </div>
                <div className="a-link">
              ...
              <div className="tech-box-wrap" id="tech1">
                ...
                <div className="tech-box">
                  ...
                  <div className="tech-box-title">
                    <h2>
                      Light Source Irradiation Angle Adjustment Technology
                    </h2>
                  </div>
                </div>
                <div className="tech-box">
            ...
            <div className="rays-wrap" id="tech2">
              <div className="rays-banner">
                <ContainerWrap>
                  ...
                  <p>
                    Uses Far-Ultraviolet (Far UV-C) light source, <br />
                    which is safe and harmless to the human body.
                  </p>
                  ...
                  <div className="rays-graph-wrap">
                    <h3>
                      Comparison between Ultraviolet
                      <br /> (UV-C)and Far-Ultraviolet
                      <br /> (Far UV-C)
                    </h3>
            ...
            <div className="thesis-wrap" id="tech3">
              <h2 className="sub-title">Academic Papers</h2>
              <ContainerWrap>
                <div className="thesis-title-wrap">
                  <div className="thesis-title">
                    <h4>
                      Paper on Far Ultraviolet Stability Verification by
                ...
                <div className="thesis-title-wrap">
                  <div className="thesis-title">
                    <h4>
                      Paper on Far-Ultraviolet Stability Verification through
                      Animal Testing by Kobe University, Japan
                    </h4>
                  </div>
                  <div className="thesis-img-wrap">
                    <div className="thesis-img">
