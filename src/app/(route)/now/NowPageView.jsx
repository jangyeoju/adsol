              ...
              <div className="now-content">
                <div className="now-content-left table">
                  <ul className="table-wrap">
                    <li>
                      <div className="table-header h-1.25">
                        <h3>Company Name</h3>
                      </div>
                      <div className="table-body h-1.25">
                    ...
                    <li>
                      ...
                      <div className="table-body h-4">
                        <h4>
                          ...
                          - 55 Hanyang University Road, Sangnok-gu, Ansan,
                          <br /> Startup Incubation Center, Room 527
                          <br />
                          <strong>(Branch Office)</strong> <br />
                          - 13 L.E.S. Road, Gunpo, <br />
                          Shinil IT Uto Knowledge Industry Center, Room 1303
                          <br />
                          <strong>(Corporate Research Institute)</strong> <br />
                          - 815 Daewang Pangyo Road, Sujeong-gu, <br />
                          Seongnam, Business Support Hub, Room 780
                          <br />
                        </h4>
                      </div>
                    </li>
          ...
          <div className="conpany-history-wrap">
            <ContainerWrap>
              ...
              <p className="sub-title-text">
                Since its establishment, the company has been growing rapidly{' '}
                <br />
                and always proves its new challenges with results.
              </p>
            </ContainerWrap>
        ...
        <InvestmentWrap>
          <div className="investment-wrap">
            <ContainerWrap>
              ...
              <p className="sub-title-text">
                Proven project execution capability with excellent technology
                through various
                <br /> commercialization projects and selection for government
                R&D projects.
              </p>
              ...
              <div className="investment-content">
                ...
                <div className="investment-content-wrap">
                  <div className="investment-box" id="investment-box2">
                    <h3>
                      ...
                      <span>Sensor and Monitoring System</span>
                    </h3>
                ...
                <div className="investment-content-wrap">
                  <div className="investment-box" id="investment-box3">
                    <div className="dp-wrap">
                      <h3>
                        Ultra-competitive Startup
                        <span>
                          Sterilization + Air Purification Clean Robot
                        </span>
                ...
                <div className="investment-content-wrap">
                  <div className="investment-box" id="investment-box4">
                    <h3>
                      Stepping Stone R&D
                      <span>Human-Safe Sterilization Robot</span>
                    </h3>
                    <div className="p-wrap">
                      <p>2023.07</p>
                      <p>2023.07</p>
                ...
                <div className="investment-content-wrap">
                  <div className="investment-box" id="investment-box5">
                    <h3>
                      Strategic R&D<span>Recycling Classification Device</span>
                    </h3>
                    <div className="p-wrap">
                      <p>2023.09</p>
                      <p>2025.06</p>
